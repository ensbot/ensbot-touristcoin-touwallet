...
var sendTxCtrl = function($scope, $sce, walletService, $rootScope) {
    ...
    $scope.sendTx = function() {
        ...
        uiFuncs.sendTx($scope.signedTx, function(resp) {
            if (!resp.isError) {
                var checkTxLink = "https://wallet.touristcoin.net?txHash=" + resp.data + "#check-tx-status";
                ...
                var verifyTxBtn = $scope.ajaxReq.type != nodes.nodeTypes.Custom ? '<a class="btn btn-xs btn-info" href="' + txHashLink + '" class="strong" target="_blank" rel="noopener noreferrer">View TX on Explorer</a>' : '';
                ...
                var checkTxBtn = '<a class="btn btn-xs btn-info" href="' + checkTxLink + '" target="_blank" rel="noopener noreferrer">View TX on Web Wallet</a>';
